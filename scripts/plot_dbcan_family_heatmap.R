...
# Calculate variability and total abundance
df$max_diff <- apply(
...
# Select the 25 most variable families, ordered from highest to lowest variation
top_df <- df %>%
...
pheatmap(
  ...
  main = expression(paste("Most variable CAZyme families across ", italic("Fomitopsis"), " species"))
)
